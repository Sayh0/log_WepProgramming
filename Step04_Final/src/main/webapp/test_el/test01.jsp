...
<body> 
	...
	<h2>비교연산</h2>
	<p>10 &gt; 2 : ${10 > 2 }</p>
	<p>10 &gt; 2 : ${10 gt 2 }</p> <!-- greater than -->
	<p>10 &ge; 2 : ${10 >= 2 }</p>
	<p>10 &ge; 2 : ${10 ge 2 }</p> <!-- greater equal -->
	
	<p>10 &lt; 2 : ${10 < 2 }</p>
	<p>10 &lt; 2 : ${10 lt 2 }</p> <!-- less than -->
	<p>10 &le; 2 : ${10 <= 2 }</p>
	<p>10 &le; 2 : ${10 le 2 }</p> <!-- less equal -->
	...
	<h2>empty 연산자 (비어 있는지 여부)</h2> <!-- 생각보다 자주 쓰인다 -->
