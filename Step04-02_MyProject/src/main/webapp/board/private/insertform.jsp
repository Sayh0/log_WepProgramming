...
<body>
	<div class="container">
		...
		<form action="insert.jsp" method="post">
			...
			<!-- 폼에서 submitContents(this)를 많이 빼먹는다. 이거 빼먹지 말 것 -->
	...
	<%--
		...
		1. webapp 에 SmartEditor  폴더를 복사해서 붙여 넣기(경로와 폴더명 변경 안됨!)
		...
		5. textarea 의 크기(width)가 SmartEditor  의 크기가 된다.
	...
	<script>
		...
		nhn.husky.EZCreator.createInIFrame({
			oAppRef: oEditors,
			elPlaceHolder: "content", //<textarea의 id="content"와 일치시켜야 스마트에디터 구현
		...
		function submitContents(elClickedObj) {
			//SmartEditor 에 의해 만들어진(작성된 글) 내용이 textarea 의 value 가 되도록 한다. 
